...
<div class="sidebar-list-single">
   <div class="top-company-list">
      <div class="company-list-logo">
         ...
         @else
         <img src="{{asset('images/default-company.png')}}" alt="{{$job->title}}" title="{{$job->title}}">
         @endif
         </a>
      </div>
      <div class="company-list-details">
         ...
         @if($job->max_salary)
         <p class="varify"><i class="fa fa-check"></i>Salario : S/{{round($job->min_salary, 0)}} - S/{{round($job->max_salary, 0)}}</p>
         @endif
      </div>
